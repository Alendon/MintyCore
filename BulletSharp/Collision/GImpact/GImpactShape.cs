...
namespace BulletSharp
{
	...
	public abstract class GImpactShapeInterface : ConcaveShape
	{
		...
		protected GImpactShapeInterface()
		{
		}
	...
	{
		public CompoundPrimitiveManager(IntPtr native, GImpactCompoundShape compoundShape)
		{
	...
	public sealed class TrimeshPrimitiveManager : PrimitiveManagerBase
	{
		...
		public TrimeshPrimitiveManager(IntPtr native, BulletObject owner)
		{
	...
	public class GImpactMeshShapePart : GImpactShapeInterface
	{
		...
		public GImpactMeshShapePart(IntPtr native, GImpactMeshShape owner)
		{
			InitializeSubObject(native, owner);
		}
	...
	public struct GImpactMeshShapeData
	{
