...
namespace MintyBulletSharp
{
	public abstract class CollisionShape : BulletDisposableObject
	{
		...
		protected void InitializeCollisionShape(IntPtr native, BulletObject owner = null)
		{
			if (owner != null)
			{
		...
		public static CollisionShape GetManaged(IntPtr obj)
		{
			if (obj == IntPtr.Zero)
			{
				return null;
