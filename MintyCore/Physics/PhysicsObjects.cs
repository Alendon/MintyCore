...
namespace MintyCore.Physics
{
    ...
    public static class PhysicsObjects
    {
        ...
        /// </summary>
        /// <returns><see cref="NativeCollisionShape" /> with a reference to the created shape</returns>
        public static NativeCollisionShape CreateCompoundShape(bool enableDynamicAabb = true,
            params (Matrix localTransform, CollisionShape shape)[] children)
        {
            var shape = new CompoundShape(enableDynamicAabb, children.Length);
            foreach (var (localTransform, childShape) in children) shape.AddChildShape(localTransform, childShape);
        ...
        /// <returns><see cref="NativeCollisionShape" /> with a reference to the created shape</returns>
        public static NativeCollisionShape CreateCompoundShape(bool enableDynamicAabb = true,
            params (Matrix localTransform, NativeCollisionShape shape)[] children)
        {
            var shape = new CompoundShape(enableDynamicAabb, children.Length);
        ...
        /// <summary>
        ///     Create a new <see cref="RigidBody" /> with a prepared <see cref="RigidBodyConstructionInfo" />. Remember to dispose
        ///     the construction info, when no longer needed
        /// </summary>
