	...
	internal unsafe class VkCommandList : CommandList
	{
		...
		public void CommandBufferCompleted( VkCommandBuffer completedCB )
		{
			...
			lock ( _secondaryCommandBufferListLock )
			{
				...
				_primaryUsedSecondaryCommandLists[completedCB].Clear();
			}
		...
		internal override CommandList GetSecondaryCommandListCore()
		{
		...
		internal override void FreeSecondaryCommandListCore()
		{
			if ( !IsSecondary )
			{
