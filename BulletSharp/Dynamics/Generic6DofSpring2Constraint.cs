...
namespace MintyBulletSharp
{
	...
	{
		public RotationalLimitMotor2(IntPtr native, BulletObject owner)
		{
	...
	{
		public TranslationalLimitMotor2(IntPtr native, BulletObject owner)
		{
			InitializeSubObject(native, owner);
		}
	...
	public class Generic6DofSpring2Constraint : TypedConstraint
	{
		...
		protected Generic6DofSpring2Constraint()
		{
		}
	...
	public unsafe struct Generic6DofSpring2ConstraintFloatData
	{
	...
	[StructLayout(LayoutKind.Sequential)]
	public unsafe struct Generic6DofSpring2ConstraintDoubleData
	{
