...
namespace MintyBulletSharp
{
	...
	public struct LocalConvexResult
	{
		...
		public LocalConvexResult(IntPtr native)
		{
			_native = native;
	...
	public struct LocalRayResult
	{
		...
		public LocalRayResult(IntPtr native)
		{
			_native = native;
	...
	public struct LocalShapeInfo
	{
		...
		public LocalShapeInfo(IntPtr native)
		{
	...
	public class CollisionWorld : BulletDisposableObject
	{
		...
		protected void InitializeMembers(Dispatcher dispatcher, BroadphaseInterface broadphasePairCache)
		{
