...
{
    [Fact]
    public void RenderModExtension_NoRegistry_GenerateCorrectCode()
    {
        ...
        var registries = Array.Empty<RegisterMethodInfo>();
        ...
        var result = SourceBuilder.RenderModExtension(modInfo, registries);
    ...
    [Fact]
    public void RenderModExtension_OneRegistry_GenerateCorrectCode()
    {
        var modInfo = new ModInfo
        {
            Namespace = "Test",
    ...
    [Fact]
    public void RenderModExtension_TwoRegistry_GenerateCorrectCode()
    {
        var modInfo = new ModInfo
        {
            Namespace = "Test",
