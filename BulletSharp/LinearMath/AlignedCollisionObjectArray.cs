...
namespace MintyBulletSharp
{
	...
	public class AlignedCollisionObjectArray : BulletObject, IList<CollisionObject>
	{
		...
		public AlignedCollisionObjectArray(IntPtr native)
		{
			Initialize(native);
		}

		public AlignedCollisionObjectArray(IntPtr native, CollisionWorld collisionWorld)
		{
			Initialize(native);
		...
		public void Add(CollisionObject item, int group, int mask)
		{
			if (item is RigidBody)
			{
				if (item.CollisionShape == null)
