...
namespace MintyBulletSharp
{
	public abstract class BroadphaseAabbCallback : BulletDisposableObject
	{
		...
		public delegate bool ProcessUnmanagedDelegate(IntPtr proxy);

		public ProcessUnmanagedDelegate _process;

		public BroadphaseAabbCallback(ConstructionInfo info)
		{
	...
	public abstract class BroadphaseInterface : BulletDisposableObject
	{
		...
		protected BroadphaseInterface()
		{
		}

		protected void InitializeMembers(OverlappingPairCache overlappingPairCache)
		{
