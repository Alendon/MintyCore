...
namespace MintyCore.Render
{
    public static unsafe class RenderPassHandler
    {
        ...
        internal static void CreateMainRenderPass(Format swapchainImageFormat)
        {
            ...
            VulkanUtils.Assert(VulkanEngine.Vk.CreateRenderPass(VulkanEngine.Device, renderPassCreateInfo, VulkanEngine.AllocationCallback,
        ...
        {
            VulkanEngine.Vk.DestroyRenderPass(VulkanEngine.Device, _defaultMainRenderPass, VulkanEngine.AllocationCallback);
