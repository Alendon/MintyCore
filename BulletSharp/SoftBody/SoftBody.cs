...
namespace BulletSharp.SoftBody
{
	...
	{
		public SoftBodyCollisionShape(IntPtr native, SoftBody owner)
		{
	...
	public class SoftBodyWorldInfo : BulletDisposableObject
	{
		...
		public SoftBodyWorldInfo(IntPtr native, BulletObject owner)
		{
	...
	public class AngularJoint : Joint
	{
		public class IControl : BulletDisposableObject
		{
			...
			public static IControl GetManaged(IntPtr native)
			{
		...
		public AngularJoint(IntPtr native)
		{
			Initialize(native);
		}
	...
	public class Body : BulletDisposableObject
	{
		...
		public Body(IntPtr native, BulletObject owner)
		{
			InitializeSubObject(native, owner);
		}
	...
	public class ContactJoint : Joint
	{
		...
		public ContactJoint(IntPtr native)
		{
			Initialize(native);
		}
	...
	public abstract class Joint : BulletObject
	{
		...
		public static Joint GetManaged(IntPtr native)
		{
			if (native == IntPtr.Zero)
			{
				return null;
	...
	public class LinearJoint : Joint
	{
		...
		public LinearJoint(IntPtr native)
		{
			Initialize(native);
		}
	...
	public class RigidContact : IDisposable
	{
		...
		public RigidContact(IntPtr native)
		{
			Native = native;
		}
	...
	public class ContactInfo : IDisposable
	{
		...
		public ContactInfo(IntPtr native)
		{
			Native = native;
		}
	...
	public class SoftContact : IDisposable
	{
		...
		public SoftContact(IntPtr native)
		{
			Native = native;
		}
	...
	public class SolverState
	{
		...
		public SolverState(IntPtr native)
		{
			Native = native;
		}
	...
	public class TetraScratch
	{
		...
		public TetraScratch(IntPtr native)
		{
			Native = native;
		}
