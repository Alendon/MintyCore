...
namespace MintyBulletSharp
{
	...
	{
		public CompoundShapeChild[] _backingArray = new CompoundShapeChild[0];

		public CompoundShapeChildArray(IntPtr compoundShape)
	...
	{
		public UIntArray(IntPtr native, int count)
			: base(native, count)
		{
		}
