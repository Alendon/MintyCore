...
namespace BulletSharp
{
	...
	{
		public GImpactQuantizedBvhNode(IntPtr native, BulletObject owner)
		{
	...
	{
		public GImpactQuantizedBvhNodeArray(IntPtr native)
		{
			Initialize(native);
		}
		/*
	...
	{
		public QuantizedBvhTree(IntPtr native, BulletObject owner)
		{
			InitializeSubObject(native, owner);
		}
