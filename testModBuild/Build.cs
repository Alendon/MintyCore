...
class Build : NukeBuild
{
    ...
    Target Restore => _ => _
        ...
        .Executes(() =>
        {
            ...
            var packageMetadataResources = sourceRepositories.Select(x => x.GetResource<PackageMetadataResource>()).ToArray();
            ...
            foreach (var (packageName, targetVersion) in GetModDependencyPackageNames(project))
            {
                ...
                if (targetVersion is null)
                    foreach (var metadataResource in packageMetadataResources)
                    {
                        ...
                        versionToUse = versionToUse is null || (version is not null && version > versionToUse) ? version : versionToUse;
                    }
